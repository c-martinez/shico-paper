...
% }
  \ForEach{ dimension $i$ in the embedded space }{
    ...
    $W_i$ $\leftarrow$ $V1_i$ projected back into vocabulary space \footnote{To convert $V1_i$ back into vocabulary space, we take the product of the embedded vector and the inverse of embedding matrix.} \footnote{If the vocabularies are different we need to convert $W_i$ to the other vocabulary} \;
